...
HD_PWD='D:/project/finder/parts/matrix_mul_vivado/work_vivado/matrix_mul_vivado.runs/mult_W18_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_W18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_W18.tcl

...
#
# Generated by export_simulation on Sat Nov 30 13:07:25 +0300 2019
#
################################################################################
...
'-reset_run' switch to the './mult_W18.sh' script.

./mult_W18.sh -reset_run
...
./mult_W18.sh -noclean_files

For more information on the script, please type './mult_W18.sh -help'.

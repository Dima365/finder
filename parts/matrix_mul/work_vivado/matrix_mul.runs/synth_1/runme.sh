...
HD_PWD='D:/project/finder/parts/matrix_mul/work_vivado/matrix_mul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mul_imag.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_mul_imag.tcl
